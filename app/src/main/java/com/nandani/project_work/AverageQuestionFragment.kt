...
import com.nandani.project_work.databinding.FragementAverageQueBinding
 ...
 * Use the [AverageQuestionFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AverageQuestionFragment : Fragment(), OptionClickInterface {
    ...
    override fun onCreateView(
        ...
        binding = FragementAverageQueBinding.inflate(layoutInflater)
...
//            if()
    ...
    private fun setQuizQuestion() {
        ...
        System.out.println(" arrayList[currentIndex].image1 ${ arrayList[currentIndex].image1}")
        System.out.println(" arrayList[currentIndex].image2 ${ arrayList[currentIndex].image2}")
        System.out.println(" arrayList[currentIndex].image3 ${ arrayList[currentIndex].image3}")
        binding.questionImage1.setImageResource(
            mainActivity.getDrawable(
                mainActivity,
                arrayList[currentIndex].image1
            )
        )
        binding.questionImage2.setImageResource(
            mainActivity.getDrawable(
                mainActivity,
                arrayList[currentIndex].image2
            )
        )
        ...
        binding.scoreView.setText(correctAnswers.toString())
        if (arrayList[currentIndex].image3 == null) {
            binding.questionImage3.visibility = View.GONE
            binding.questionPlus2.visibility = View.GONE
        } else {
            binding.questionImage3.visibility = View.VISIBLE
            binding.questionPlus2.visibility = View.VISIBLE
            binding.questionImage3.setImageResource(
                mainActivity.getDrawable(
                    mainActivity,
                    arrayList[currentIndex].image3
                )
            )
        }
